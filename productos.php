...
<?
echo "<a href='productos.php?pagi=".($totals*12-24)."'>";
?>
...
if ($i!=$totals){
	$totalp=($i*12)-12;
	echo "<a href='productos.php?pagi=$totalp'>";
}
?>
<?php echo $i;
if ($i!=$totals){
...
?>
    <li class="waves-effect">
<?
echo "<a href='productos.php?pagi=".($totals*12)."'>";
?>
...
<?
					...
					//echo round($div);
					echo "<center><h5>";
					echo "<a href='productos'><img src='img/home1.png' width='65' height='40'></a>";
